...
if(isset($_GET['id']))
{
    ...
    //sql query to get all selected food
...
<div class="main-content">
    <div class="wrapper">
                        ...
                        <select name="category">
                            ...
                            if($count>0)
                            {
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
                                   ...
                                   // echo "<option value='$category_id'>$category_title </optiom>";
                                   ?>
        ...
        if(isset($_POST['submit']))
        {
           ...
           //check whether the query is executd
           if($res3==true)
           {
